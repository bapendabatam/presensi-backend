...
CREATE TABLE IF NOT EXISTS tb_presensi_new (
	...
	id_subgroup INTEGER NOT NULL,
	jabatan TEXT NULL CHECK(LENGTH(jabatan) <= 100),
	id_jenis_kepegawaian INTEGER NULL,
	id_gender INTEGER NULL,
	no_hp TEXT NULL CHECK(LENGTH(no_hp) <= 20),
	email TEXT NULL CHECK(LENGTH(email) <= 100),
	latitude REAL NOT NULL,
	longitude REAL NOT NULL,
